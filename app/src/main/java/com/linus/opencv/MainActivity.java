...
import com.linus.opencv_android.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        show_image.setImageResource(R.mipmap.cat);
    ...
    private void grayPic(){
        ...
        //recall JNI
        int[] resultInt = getCrayImage(pixels, w, h);
    ...
    public native int[] getCrayImage(int[] pixels, int w, int h);
}
